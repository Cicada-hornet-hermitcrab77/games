...
SEASONAL_EVENTS = [
    ...
    {"name": "Legacy of Valor",      "start": (5, 25),  "end": (5, 25),  "deco": "memorial",
     "special_mode": "tombstones_minefield", "special_mode_label": "Tombstone's Minefield",
     "special_mode_cost": 50},
    ...
    {"name": "Novel Beginnings",     "start": (8, 10),  "end": (8, 16),  "deco": "school",
     "special_mode": "booked", "special_mode_label": "Booked"},
    {"name": "Project Yellowstone",  "start": (8, 25),  "end": (8, 25),  "deco": "mountain",
     "special_mode": "rolling_stones", "special_mode_label": "Rollin' Stones"},
    {"name": "Echoes of the Undying","start": (10,31),  "end": (11, 6),  "deco": "halloween",
     "special_mode": "crooking_glass", "special_mode_label": "The Crooking Glass"},
